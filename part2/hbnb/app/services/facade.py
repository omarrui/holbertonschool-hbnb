...
class HBnBFacade:
    """Facade providing business operations for Users, Amenities, Places and Reviews.

    Uses simple in-memory repositories. Validations for basic attributes are
    delegated to model setters (e.g. Place.price, Review.text, Review.rating).
    """
    ...
    def create_review(self, data):
        ...
        # Review model will validate text and rating
    ...
    def delete_review(self, review_id):
        ...
        return True
"""Clean HBnBFacade implementation.

Provides business logic for Users, Amenities, Places and Reviews using in-memory
repositories. Validates relations and relies on model-level validation where
appropriate.
"""
